  ...
  return (
    ...
    >
      <div className="grid gap-4 md:grid-cols-2">
        <article className="rounded-xl border border-destructive/25 bg-background p-5">
        ...
        <article className="rounded-xl border border-primary/30 bg-background p-5 shadow-sm ring-1 ring-primary/10">
          <div className="flex items-center justify-between gap-2">
